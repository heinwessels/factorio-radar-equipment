...
data:extend{
  ...
  },
  {
    ...
    name = "radar-equipment",
    localised_description = {"equipment-description.radar-equipment"},
    custom_tooltip_fields = {{
      name = {"description.continuous-radar-coverage-distance"},
      value = "3", -- Won't be true if other mod changes it. Just ask me!
    }},
    sprite = {
